...
impl Signature {
    ...
    /// these applications secp256k1 will only accept signatures for which
...
impl<C> Secp256k1<C> {
    ...
    /// see comment in secp256k1 commit d2275795f by Gregory Maxwell. Requires
...
impl<C: Verification> Secp256k1<C> {
    ...
    /// which OpenSSL would verify but not secp256k1, or vice-versa. Requires a
